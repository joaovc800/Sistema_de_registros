    ...
    <div class="wrapper d-flex align-items-stretch">
        <nav id="sidebar" class="active h-100 fixed-top">
            ...
            <ul class="list-unstyled components mb-5">
                ...
                <li class="nav-item dropend">
                    <a class="nav-link" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"><span
                            class="fas fa-search"></span>Buscar</a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item text-light text-center" href="buscar2.php">Por Data</a></li>
                        <li><a class="dropdown-item text-light text-center" href="buscar.php">Por Matricula ou RA</a>
                        </li>
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDarkDropdownMenuLink">
                                        <li><a class="dropdown-item text-center text-dark" href="buscar2.php">Por
                                                Data</a></li>
                                        <li><a class="dropdown-item text-center text-dark" href="buscar.php">Por
                                                Matricula ou RA</a></li>
                                        <li><a class="dropdown-item text-center text-dark" href="buscar3.php">Por
                                                Assunto</a></li>
                                    </ul>
                                </li>
                            </ul>
        ...
        ?>
                <div class="col-md-12 blr3">
                            ...
                            <div class="row">
                                <form action="php/update.php" method="POST">
                                    <div class="col-md-12">
                                        ...
                                        <input name="registro" type="text" class="form-control form-control-sm"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            value="<?php echo $req?>" readonly>
                                    </div>
                                    <!-- divisão -->
                                    <div class="col-md-12">
                                        <p class="text-left down">Matricula / RA ↓</p>
                                        <input type="number" class="form-control form-control-sm"
                                            value="<?php echo $mat?>" readonly>
                                    </div>
                                    <!-- divisão -->
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            value="<?php echo $assunt?>" readonly>
                                    </div>
                                    <!-- divisão -->
                                    <div class="col-md-12">
                                        <p class="text-left down">Data e hora do registro aberto ↓</p>
                                        <input type="text" class="form-control form-control-sm"
                                            value="<?php echo $data.' as '.$hora?>" readonly>
                                    </div>
                                    <!-- divisão -->
                                    <div class="col-md-12">
                                        <div class="card mt-2">
                                            <p class="text-dark p-2">Registrado por:
                                                <?php echo "<b>".$resp."</b> em $data as $hora"."<br><br>".$res?></p>
                                        </div>
                                        <?php
                    ...
                    ?>
                                        <div class="card mt-2">
                                            <p class="text-dark">Atualizado por:
                                                <?php echo "<b>".$respAlt."</b> em $data as $hora"."<br><br>".$atualizacao?>
                                            </p>
                                        </div>
                                        <?php
                    }
                  ?>
                            ...
                            <div class="container col-md-12">
                                ...
                                <div class="form-floating" id="textArea">
                                    <textarea name="res" id="texto" class="form-control form-control-sm mt-2"
                                        id="floatingTextarea2" style="height: 100px" maxlength="400"></textarea><label
                                        for="floatingTextarea2">Resolução</label>
                                </div>
                            ...
                            <div class="container">
                                <button id="btn" type="submit" class="p-1 w-100 mt-2 btn btn-success btn-lg">Concluir
                                    <span class="fas fa-check-circle"></button>
                            </div>
                            </form>
                        </div>
                    </div>
