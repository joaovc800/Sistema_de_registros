...
<html lang="pt-BR">
  ...
  <body>
        ...
        <ul class="list-unstyled components mb-5">
          ...
          <li>
              <a href="registrar.php"><span class="fa fa-user"></span> Registrar</a>
          </li>
          <li>
      ...
      <div class="container">
        ...
        <?php
            ...
            $query = "SELECT *,TIME_FORMAT(hora, '%H:%i')as hora_formatada,DATE_FORMAT(data, '%d/%m/%Y') as data_formatada FROM registros";
         ...
         <div class="col-md-4">
                ...
                <div class="card-body">
                  ...
                  <ul class="list-unstyled mt-3 mb-4">
                    ...
                    <li class="text-dark">Resolução: <?php echo"<b>".$res."</b>"?></li>
                  </ul>
                </div>
              </div>
            </div>  
