         ...
         <div class="col-md-12 blr3">
                ...
                <h5 class="card-title pricing-card-title">
                  ...
                  <ul class="list-unstyled mt-3 mb-4">
                    ...
                    <div class="card mt-2">
                      <li class="text-dark">Atualizado por: <?php echo $resp." <br>"."<b>".$res."</b>"?></li>
                    </div>
                    <?php
                      $query2 = "SELECT * FROM updates WHERE n_registro = '$id'";
                    ...
                    ?>
                    <div class="card mt-2">
                      <li class="text-dark">Atualizado por: <?php echo $respAlt." <br>"."<b>".$atualizacao."</b>"?></li>
                    </div>
                    <?php
                    }
                  ?>
